...
func (h HashedPassword) EqWithString(password string) bool {
  return bcrypt.CompareHashAndPassword([]byte(h.Underlying()), []byte(password)) == nil
}

func (h HashedPassword) Eq(password Password) bool {
