...
func NewCustomerCreatedV1(customerId types.Id, email types.Email, username string) *CustomerCreatedV1 {
  return &CustomerCreatedV1{
    IntegrationEventBaseV1: types.NewIntegrationEventV1(),
...
func (c *CustomerEmailChangedV1) Key() string {
  return c.CustomerId
}
...
func (c *CustomerPhotoChangedV1) Key() string {
  return c.CustomerId
}
